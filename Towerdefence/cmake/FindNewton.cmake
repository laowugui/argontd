...
if (NOT Newton_FOUND)
	message("-- Manualy looking for Newton")
	...
	if (WIN32)
		...
		set(Newton_INCLUDE_DIRS /usr/include/newtonSDK /usr/local/include/newtonSDK)
		set(Newton_LIBRARY_DIRS /usr/lib /usr/local/lib )
	endif()
